  ...
  try {
    ...
    await fetch(getApiUrl(ENDPOINT), {
      ...
      body: JSON.stringify({
        ...
        drawNo,
        insight: insight && {
          score: insight.recommendation.popularityPercentile === null ? null : 1 - insight.recommendation.popularityPercentile,
          popularity: insight.recommendation.popularity,
          popularityPercentile: insight.recommendation.popularityPercentile,
          ...
          model: {
            ...
            trainedDraws: insight.stats.trainedDraws,
            featureCount: insight.stats.featureCount,
            maxPastOverlap: insight.stats.maxPastOverlap,
            maxPercentile: insight.stats.maxPercentile,
            validationDraws: insight.stats.validation?.draws ?? null,
            validationCorrelation: insight.stats.validation?.correlation ?? null,
            quietShare: insight.stats.validation?.quietShare ?? null,
            allShare: insight.stats.validation?.allShare ?? null,
          },
        },
      }),
    })
