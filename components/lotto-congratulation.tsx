...
export default function LottoCongratulation({ show, className }: LottoCongratulationProps) {
  ...
  return (
    <motion.div
      ...
      className={`w-full ${className || "max-w-md"} mb-6 p-4 bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20 rounded-lg border border-blue-100 dark:border-blue-900/40 text-center`}
    >
