    ...
    <div className="flex items-center justify-center flex-1 bg-gray-50">
      <div className="w-full max-w-md p-8 space-y-6 bg-white rounded-lg shadow-md">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2 mt-1 text-gray-900 bg-gray-100 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
            />
          </div>
          <div>
        ...
        <p className="text-sm text-center text-gray-600">
          이미 계정이 있으신가요? <Link href="/login" className="font-medium text-blue-600 hover:underline">로그인</Link>
        </p>
      </div>
    </div>
  )
